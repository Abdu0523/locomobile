...
<title>Loc'Omobile | My Profile</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/dealerlogo.jpg" alt="image">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Parametre General </h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCCES</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Registré le -</label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">Derniere mis à jour  -</label>
            ...
            <div class="form-group">
              <label class="control-label">Addresse Mail </label>
            ...
            <div class="form-group">
              <label class="control-label">Date de Naissance&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <label class="control-label">Votre Addresse</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Savegarder <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
