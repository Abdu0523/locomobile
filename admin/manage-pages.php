				...
				<div class="row">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">CHAMP DE FORMULAIRE</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERREUR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">selectez la Page</label>
												<div class="col-sm-8">
															   <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                  <option value="" selected="selected" class="form-control">***Select***</option>
                  <option value="manage-pages.php?type=terms">termes & condition</option>
                  <option value="manage-pages.php?type=privacy">privacy and policy</option>
                  <option value="manage-pages.php?type=aboutus">A propros</option> 
                  <option value="manage-pages.php?type=faqs">FAQs</option>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Page selectionnée </label>
												<div class="col-sm-8">
						<?php
...
?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn">Sauvegarder</button>
												</div>
											</div>
