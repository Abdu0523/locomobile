...
<head>
	...
	<title>Loc'Omobile | Admin Dashboard</title>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Utilisateurs inscris</div>
												</div>
											</div>
											<a href="reg-users.php" class="block-anchor panel-footer"> Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
													...
													<div class="stat-panel-title text-uppercase"> Vehicules </div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Reservations</div>
												</div>
											</div>
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Liste des marques</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Abonnés</div>
												</div>
											</div>
											<a href="manage-subscribers.php" class="block-anchor panel-footer"> Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
													...
													<div class="stat-panel-title text-uppercase">Requetes</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Temoignage</div>
												</div>
											</div>
