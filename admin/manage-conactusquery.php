...
<head>
	...
	<title>Loc'Omobile |Admin Manage Queries   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestion des requetes de Contact</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Requete Utilisateur</div>
...
<td><a href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to read')" >En Attente</a>
</td>
<?php } ?>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
