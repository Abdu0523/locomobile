...
<head>
	...
	<title>Loc'Omobile |Admin Manage Brands   </title>
...
<a href="manage-brands.php?del=<?php echo $result->id;?>" onclick="return confirm('Voulez vous supprimer');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
