...
<title>Loc'Omobile |Post testimonial</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Poster un Temoignage</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Accueil</a></li>
        <li>Poster un Temoignage</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Editeur de text</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Temoignage</label>
              <textarea class="form-control white_bg" name="testimonial" rows="4" required=""></textarea>
            </div>
          
           
            <div class="form-group">
              <button type="submit" name="submit" class="btn">Envoyer  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
