...
<title>Loc'Omobile|Bookings</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Mes Reservations </h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>date du:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>jusqu'au:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Annulé</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Sous traitement ...</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
